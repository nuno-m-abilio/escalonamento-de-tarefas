...
tarefas_agendadas: list[c.Tarefa] = []
...
def trata_mensagem(mensagem: dict, addr):
    ...
    '''
    global tarefas_agendadas, emissao_finalizada
...
def main(entrada: str):
    '''
    Função principal que carrega as tarefas, inicia o servidor socket e aguarda
    as mensagens do clock.
    '''
